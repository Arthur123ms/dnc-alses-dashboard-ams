...
describe('jwtExperationDateConverter', () => {
    ...
    it('should retur 0 when the esxp is at the same time', () => {
        ...
        it('should corectly convert expiration date in a fraction of day. 12 hours in the future', () => {
